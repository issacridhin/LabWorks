...
public class AmazonCRM {
    ...
    public static void main(String[] args) {
        ...
        AmazonCRM acrm = new AmazonCRM();
         ...
         Customer customer1 = new Customer(234, "Issac", 625013);
         Customer customer2 = new Customer(235, "Deyon", 625009);

         Product product1 = new Product(777, "Asus ROG");
         Product product2 = new Product(888, "HP Victus");
